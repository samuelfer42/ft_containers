...
namespace ft
{
	...
	public:
		...
		typedef ft::pair<const key_type, mapped_type> value_type; // type de la paire cle/valeur
		typedef Compare key_compare; // type de la fonction de comparaison des cle
		typedef Alloc allocator_type; // type de l'allocateur
		typedef typename allocator_type::reference reference; // type de reference
		typedef typename allocator_type::const_reference const_reference; // type de reference constante
		...
		typedef ft::rbtree_iterator<value_type> iterator; // type d'iterateur
		typedef ft::rbtree_const_iterator<value_type> const_iterator; // type d'iterateur constant
		typedef ft::reverse_iterator<iterator> reverse_iterator; // type d'iterateur inverse
		typedef ft::reverse_iterator<const_iterator> const_reverse_iterator; // type d'iterateur inverse constant
	...
	public:
		...
		public:
			typedef bool result_type; // type de resultat
			typedef value_type first_argument_type; // type du premier argument
			typedef value_type second_argument_type; // type du second argument
